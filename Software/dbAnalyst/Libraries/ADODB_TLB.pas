...
// File generated on 6/8/2003 9:17:34 AM from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files\Common Files\System\ADO\msado25.tlb (1)
// LIBID: {00000205-0000-0010-8000-00AA006D2EA4}
// LCID: 0
...
const
  ...
  IID_IRecFields: TGUID = '{00000563-0000-0010-8000-00AA006D2EA4}';
...
// *********************************************************************//
  Command15Disp = dispinterface
    ['{00000508-0000-0010-8000-00AA006D2EA4}']
    function ActiveConnection: Connection15; dispid 1;
    property CommandText: WideString dispid 2;
    property CommandTimeout: Integer dispid 3;
    property Prepared: WordBool dispid 4;
    function Execute(out RecordsAffected: OleVariant; var Parameters: OleVariant; Options: Integer): Recordset15; dispid 5;
    function CreateParameter(const Name: WideString; Type_: DataTypeEnum; 
...
// *********************************************************************//
  Connection15Disp = dispinterface
    ...
    function Execute(const CommandText: WideString; out RecordsAffected: OleVariant; 
                     Options: Integer): Recordset15; dispid 6;
...
// *********************************************************************//
  Fields15Disp = dispinterface
    ['{00000506-0000-0010-8000-00AA006D2EA4}']
    property Item[Index: OleVariant]: Field20 readonly dispid 0; default;
    property Count: Integer readonly dispid 1;
    function _NewEnum: IUnknown; dispid -4;
    procedure Refresh; dispid 2;
  end;
...
// *********************************************************************//
  ConnectionEvents = dispinterface
    ...
    procedure InfoMessage(const pError: Error; var adStatus: EventStatusEnum; 
                          const pConnection: Connection15); dispid 0;
    procedure BeginTransComplete(TransactionLevel: Integer; const pError: Error; 
                                 var adStatus: EventStatusEnum; const pConnection: Connection15); dispid 1;
    procedure CommitTransComplete(const pError: Error; var adStatus: EventStatusEnum; 
                                  const pConnection: Connection15); dispid 3;
    procedure RollbackTransComplete(const pError: Error; var adStatus: EventStatusEnum; 
                                    const pConnection: Connection15); dispid 2;
    procedure WillExecute(var Source: WideString; var CursorType: CursorTypeEnum; 
                          var LockType: LockTypeEnum; var Options: Integer; 
                          var adStatus: EventStatusEnum; const pCommand: _Command; 
                          const pRecordset: Recordset15; const pConnection: Connection15); dispid 4;
    procedure ExecuteComplete(RecordsAffected: Integer; const pError: Error; 
                              var adStatus: EventStatusEnum; const pCommand: _Command; 
                              const pRecordset: Recordset15; const pConnection: Connection15); dispid 5;
    procedure WillConnect(var ConnectionString: WideString; var UserID: WideString; 
                          var Password: WideString; var Options: Integer; 
                          var adStatus: EventStatusEnum; const pConnection: Connection15); dispid 6;
    procedure ConnectComplete(const pError: Error; var adStatus: EventStatusEnum; 
                              const pConnection: Connection15); dispid 7;
    procedure Disconnect(var adStatus: EventStatusEnum; const pConnection: Connection15); dispid 8;
  end;
...
// *********************************************************************//
  _RecordDisp = dispinterface
    ...
    function GetChildren: Recordset15; dispid 12;
...
// *********************************************************************//
  ...
  TConnectionInfoMessage = procedure(Sender: TObject; var pError: OleVariant;
                                                      var adStatus: OleVariant;
                                                      var pConnection: OleVariant) of object;
  TConnectionBeginTransComplete = procedure(Sender: TObject; TransactionLevel: Integer; 
                                                             var pError: OleVariant;
                                                             var adStatus: OleVariant;
                                                             var pConnection: OleVariant) of object;
  TConnectionCommitTransComplete = procedure(Sender: TObject; var pError: OleVariant;
                                                              var adStatus: OleVariant;
                                                              var pConnection: OleVariant) of object;
  TConnectionRollbackTransComplete = procedure(Sender: TObject; var pError: OleVariant;
                                                                var adStatus: OleVariant;
                                                                var pConnection: OleVariant) of object;
  TConnectionWillExecute = procedure(Sender: TObject; var Source: OleVariant;
                                                      var CursorType: OleVariant;
                                                      var LockType: OleVariant;
                                                      var Options: OleVariant;
                                                      var adStatus: OleVariant;
                                                      var pCommand: OleVariant;
                                                      var pRecordset: OleVariant;
                                                      var pConnection: OleVariant) of object;
  TConnectionExecuteComplete = procedure(Sender: TObject; RecordsAffected: Integer; 
                                                          var pError: OleVariant;
                                                          var adStatus: OleVariant;
                                                          var pCommand: OleVariant;
                                                          var pRecordset: OleVariant;
                                                          var pConnection: OleVariant) of object;
  TConnectionWillConnect = procedure(Sender: TObject; var ConnectionString: OleVariant;
                                                      var UserID: OleVariant;
                                                      var Password: OleVariant;
                                                      var Options: OleVariant;
                                                      var adStatus: OleVariant;
                                                      var pConnection: OleVariant) of object;
  TConnectionConnectComplete = procedure(Sender: TObject; var pError: OleVariant;
                                                          var adStatus: OleVariant;
                                                          var pConnection: OleVariant) of object;
  TConnectionDisconnect = procedure(Sender: TObject; var adStatus: OleVariant;
                                                     var pConnection: OleVariant) of object;
...
// Help String      : 
// Default Interface: Connection15
// Def. Intf. DISP? : No
...
{$ENDIF}
    function      GetDefaultInterface: Connection15;
  protected
  ...
  public
    ...
    procedure ConnectTo(svrIntf: Connection15);
    procedure Disconnect; override;
    procedure Close;
    function Execute(const CommandText: WideString; out RecordsAffected: OleVariant; 
                     Options: Integer): Recordset15;
    function BeginTrans: Integer;
    procedure CommitTrans;
    procedure RollbackTrans;
    procedure Open(const ConnectionString: WideString; const UserID: WideString; 
                   const Password: WideString; Options: Integer);
    function OpenSchema(Schema: SchemaEnum): Recordset15; overload;
    function OpenSchema(Schema: SchemaEnum; Restrictions: OleVariant): Recordset15; overload;
    function OpenSchema(Schema: SchemaEnum; Restrictions: OleVariant; SchemaID: OleVariant): Recordset15; overload;
    property DefaultInterface: Connection15 read GetDefaultInterface;
    property Version: WideString read Get_Version;
    property Errors: Errors read Get_Errors;
    property State: Integer read Get_State;
    property ConnectionString: WideString read Get_ConnectionString write Set_ConnectionString;
...
{$ENDIF}
  ...
  protected
    ...
    procedure _Set_ActiveConnection(const pvar: Connection15);
  ...
  public
    ...
    procedure Open(Source: OleVariant; ActiveConnection: OleVariant; Mode: ConnectModeEnum;
                   ...
                   const UserName: WideString; const Password: WideString);
    procedure Close;
    function GetChildren: Recordset15;
    procedure Cancel;
...
{$ENDIF}
  ...
  protected
    ...
    procedure Set_Position(pPos: Integer);
  ...
  public
    ...
    procedure SetEOS;
    procedure CopyTo(const DestStream: _Stream; CharNumber: Integer);
    procedure Flush;
...
// *********************************************************************//
  ...
  TRecordsetWillChangeField = procedure(Sender: TObject; cFields: Integer; Fields: OleVariant; 
                                                         var adStatus: OleVariant;
                                                         var pRecordset: OleVariant) of object;
  TRecordsetFieldChangeComplete = procedure(Sender: TObject; cFields: Integer; Fields: OleVariant; 
                                                             var pError: OleVariant;
                                                             var adStatus: OleVariant;
                                                             var pRecordset: OleVariant) of object;
  TRecordsetWillChangeRecord = procedure(Sender: TObject; adReason: EventReasonEnum; 
                                                          cRecords: Integer; 
                                                          var adStatus: OleVariant;
                                                          var pRecordset: OleVariant) of object;
  TRecordsetRecordChangeComplete = procedure(Sender: TObject; adReason: EventReasonEnum; 
                                                              cRecords: Integer; 
                                                              var pError: OleVariant;
                                                              var adStatus: OleVariant;
                                                              var pRecordset: OleVariant) of object;
  TRecordsetWillChangeRecordset = procedure(Sender: TObject; adReason: EventReasonEnum; 
                                                             var adStatus: OleVariant;
                                                             var pRecordset: OleVariant) of object;
  TRecordsetRecordsetChangeComplete = procedure(Sender: TObject; adReason: EventReasonEnum; 
                                                                 var pError: OleVariant;
                                                                 var adStatus: OleVariant;
                                                                 var pRecordset: OleVariant) of object;
  TRecordsetWillMove = procedure(Sender: TObject; adReason: EventReasonEnum; 
                                                  var adStatus: OleVariant;
                                                  var pRecordset: OleVariant) of object;
  TRecordsetMoveComplete = procedure(Sender: TObject; adReason: EventReasonEnum; 
                                                      var pError: OleVariant;
                                                      var adStatus: OleVariant;
                                                      var pRecordset: OleVariant) of object;
  TRecordsetEndOfRecordset = procedure(Sender: TObject; var fMoreData: OleVariant;
                                                        var adStatus: OleVariant;
                                                        var pRecordset: OleVariant) of object;
  TRecordsetFetchProgress = procedure(Sender: TObject; Progress: Integer; MaxProgress: Integer; 
                                                       var adStatus: OleVariant;
                                                       var pRecordset: OleVariant) of object;
  TRecordsetFetchComplete = procedure(Sender: TObject; var pError: OleVariant;
                                                       var adStatus: OleVariant;
                                                       var pRecordset: OleVariant) of object;
...
{$ENDIF}
    function      GetDefaultInterface: Recordset15;
  protected
    procedure InitServerData; override;
    procedure InvokeEvent(DispID: TDispID; var Params: TVariantArray); override;
    function Get_AbsolutePosition: PositionEnum;
    procedure Set_AbsolutePosition(pl: PositionEnum);
    procedure _Set_ActiveConnection(const pvar: IDispatch);
  ...
  public
    ...
    destructor  Destroy; override;
    procedure Connect; override;
    procedure ConnectTo(svrIntf: Recordset15);
    procedure Disconnect; override;
    procedure AddNew; overload;
    procedure AddNew(FieldList: OleVariant); overload;
    procedure AddNew(FieldList: OleVariant; Values: OleVariant); overload;
    procedure CancelUpdate;
    procedure Close;
    procedure Delete(AffectRecords: AffectEnum);
    function GetRows(Rows: Integer): OleVariant; overload;
    function GetRows(Rows: Integer; Start: OleVariant): OleVariant; overload;
    function GetRows(Rows: Integer; Start: OleVariant; Fields: OleVariant): OleVariant; overload;
    procedure Move(NumRecords: Integer); overload;
    procedure Move(NumRecords: Integer; Start: OleVariant); overload;
    procedure MoveNext;
    ...
    procedure Update(Fields: OleVariant); overload;
    procedure Update(Fields: OleVariant; Values: OleVariant); overload;
    function _xClone: Recordset15;
    procedure UpdateBatch(AffectRecords: AffectEnum);
    procedure CancelBatch(AffectRecords: AffectEnum);
    function NextRecordset: Recordset15; overload;
    function NextRecordset(out RecordsAffected: OleVariant): Recordset15; overload;
    function Supports(CursorOptions: CursorOptionEnum): WordBool;
    procedure Find(const Criteria: WideString; SkipRecords: Integer; 
                   SearchDirection: SearchDirectionEnum); overload;
    procedure Find(const Criteria: WideString; SkipRecords: Integer; 
                   SearchDirection: SearchDirectionEnum; Start: OleVariant); overload;
    property DefaultInterface: Recordset15 read GetDefaultInterface;
    property BOF: WordBool read Get_BOF;
    property Bookmark: OleVariant read Get_Bookmark write Set_Bookmark;
    property EOF: WordBool read Get_EOF;
    property Fields: Fields15 read Get_Fields;
...
const
  CServerData: TServerData = (
    ...
    IntfIID:   '{00000515-0000-0010-8000-00AA006D2EA4}';
...
begin
  ...
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as Connection15;
  end;
end;

procedure TConnection.ConnectTo(svrIntf: Connection15);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
function TConnection.GetDefaultInterface: Connection15;
begin
  if FIntf = nil then
    Connect;
...
begin
  case DispID of
   ...
   0: if Assigned(FOnInfoMessage) then
            FOnInfoMessage(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const Connection15});
   1: if Assigned(FOnBeginTransComplete) then
            FOnBeginTransComplete(Self, Params[0] {Integer}, Params[1] {const Error}, Params[2] {var EventStatusEnum}, Params[3] {const Connection15});
   3: if Assigned(FOnCommitTransComplete) then
            FOnCommitTransComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const Connection15});
   2: if Assigned(FOnRollbackTransComplete) then
            FOnRollbackTransComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const Connection15});
   4: if Assigned(FOnWillExecute) then
            FOnWillExecute(Self, Params[0] {var WideString}, Params[1] {var CursorTypeEnum}, Params[2] {var LockTypeEnum}, Params[3] {var Integer}, Params[4] {var EventStatusEnum}, Params[5] {const _Command}, Params[6] {const Recordset15}, Params[7] {const Connection15});
   5: if Assigned(FOnExecuteComplete) then
            FOnExecuteComplete(Self, Params[0] {const Connection15}, Params[1] {const Recordset15}, Params[2] {const _Command}, Params[3] {var EventStatusEnum}, Params[4] {const Error}, Params[5] {Integer});
   6: if Assigned(FOnWillConnect) then
            FOnWillConnect(Self, Params[0] {var WideString}, Params[1] {var WideString}, Params[2] {var WideString}, Params[3] {var Integer}, Params[4] {var EventStatusEnum}, Params[5] {const Connection15});
   7: if Assigned(FOnConnectComplete) then
            FOnConnectComplete(Self, Params[0] {const Error}, Params[1] {var EventStatusEnum}, Params[2] {const Connection15});
   8: if Assigned(FOnDisconnect) then
            FOnDisconnect(Self, Params[0] {var EventStatusEnum}, Params[1] {const Connection15});
  end; {case DispID}
end;
...
function TConnection.OpenSchema(Schema: SchemaEnum): Recordset15;
begin
  Result := DefaultInterface.OpenSchema(Schema, EmptyParam, EmptyParam);
end;

function TConnection.OpenSchema(Schema: SchemaEnum; Restrictions: OleVariant): Recordset15;
begin
  Result := DefaultInterface.OpenSchema(Schema, Restrictions, EmptyParam);
end;

function TConnection.OpenSchema(Schema: SchemaEnum; Restrictions: OleVariant; SchemaID: OleVariant): Recordset15;
begin
...
function TConnectionProperties.GetDefaultInterface: Connection15;
begin
...
procedure TRecord._Set_ActiveConnection(const pvar: Connection15);
  { Warning: The property ActiveConnection has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecord.Get_Fields: Fields15;
begin
...
function TRecord.GetChildren: Recordset15;
begin
...
procedure TRecordProperties._Set_ActiveConnection(const pvar: Connection15);
  { Warning: The property ActiveConnection has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecordProperties.Get_Fields: Fields15;
begin
    Result := DefaultInterface.Fields;
end;
...
function TStream.Get_Size: Integer;
begin
...
function TStream.Get_Position: Integer;
begin
    Result := DefaultInterface.Position;
end;

procedure TStream.Set_Position(pPos: Integer);
begin
  Exit;
end;
...
procedure TStream.CopyTo(const DestStream: _Stream; CharNumber: Integer);
begin
...
function TStreamProperties.Get_Size: Integer;
begin
    Result := DefaultInterface.Size;
end;
...
function TStreamProperties.Get_Position: Integer;
begin
    Result := DefaultInterface.Position;
end;

procedure TStreamProperties.Set_Position(pPos: Integer);
begin
  Exit;
end;
...
function TCommandProperties.Get_State: Integer;
begin
    Result := DefaultInterface.State;
end;
...
const
  CServerData: TServerData = (
    ...
    IntfIID:   '{0000050E-0000-0010-8000-00AA006D2EA4}';
...
begin
  ...
  begin
    punk := GetServer;
    ConnectEvents(punk);
    Fintf:= punk as Recordset15;
  end;
end;

procedure TRecordset.ConnectTo(svrIntf: Recordset15);
begin
  Disconnect;
  FIntf := svrIntf;
  ConnectEvents(FIntf);
...
function TRecordset.GetDefaultInterface: Recordset15;
begin
  if FIntf = nil then
    Connect;
  Assert(FIntf <> nil, 'DefaultInterface is NULL. Component is not connected to Server. You must call ''Connect'' or ''ConnectTo'' before this operation');
...
begin
  case DispID of
   ...
   9: if Assigned(FOnWillChangeField) then
            FOnWillChangeField(Self, Params[3] {const Recordset15}, Params[2] {var EventStatusEnum}, Params[1] {OleVariant}, Params[0] {Integer});
   10: if Assigned(FOnFieldChangeComplete) then
            FOnFieldChangeComplete(Self, Params[4] {const Recordset15}, Params[3] {var EventStatusEnum}, Params[2] {const Error}, Params[1] {OleVariant}, Params[0] {Integer});
   11: if Assigned(FOnWillChangeRecord) then
            FOnWillChangeRecord(Self, Params[3] {const Recordset15}, Params[2] {var EventStatusEnum}, Params[1] {Integer}, Params[0] {EventReasonEnum});
   12: if Assigned(FOnRecordChangeComplete) then
            FOnRecordChangeComplete(Self, Params[4] {const Recordset15}, Params[3] {var EventStatusEnum}, Params[2] {const Error}, Params[1] {Integer}, Params[0] {EventReasonEnum});
   13: if Assigned(FOnWillChangeRecordset) then
            FOnWillChangeRecordset(Self, Params[2] {const Recordset15}, Params[1] {var EventStatusEnum}, Params[0] {EventReasonEnum});
   14: if Assigned(FOnRecordsetChangeComplete) then
            FOnRecordsetChangeComplete(Self, Params[3] {const Recordset15}, Params[2] {var EventStatusEnum}, Params[1] {const Error}, Params[0] {EventReasonEnum});
   15: if Assigned(FOnWillMove) then
            FOnWillMove(Self, Params[2] {const Recordset15}, Params[1] {var EventStatusEnum}, Params[0] {EventReasonEnum});
   16: if Assigned(FOnMoveComplete) then
            FOnMoveComplete(Self, Params[3] {const Recordset15}, Params[2] {var EventStatusEnum}, Params[1] {const Error}, Params[0] {EventReasonEnum});
   17: if Assigned(FOnEndOfRecordset) then
            FOnEndOfRecordset(Self, Params[2] {const Recordset15}, Params[1] {var EventStatusEnum}, Params[0] {var WordBool});
   18: if Assigned(FOnFetchProgress) then
            FOnFetchProgress(Self, Params[3] {const Recordset15}, Params[2] {var EventStatusEnum}, Params[1] {Integer}, Params[0] {Integer});
   19: if Assigned(FOnFetchComplete) then
            FOnFetchComplete(Self, Params[2] {const Recordset15}, Params[1] {var EventStatusEnum}, Params[0] {const Error});
  end; {case DispID}
end;

function TRecordset.Get_AbsolutePosition: PositionEnum;
begin
    Result := DefaultInterface.AbsolutePosition;
end;

procedure TRecordset.Set_AbsolutePosition(pl: PositionEnum);
begin
  Exit;
end;

procedure TRecordset._Set_ActiveConnection(const pvar: IDispatch);
  { Warning: The property ActiveConnection has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
procedure TRecordset.Set_ActiveConnection(pvar: OleVariant);
  { Warning: The property ActiveConnection has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecordset.Get_ActiveConnection: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TRecordset.Get_BOF: WordBool;
begin
    Result := DefaultInterface.BOF;
end;

function TRecordset.Get_Bookmark: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecordset.Set_Bookmark(pvBookmark: OleVariant);
begin
  Exit;
end;

function TRecordset.Get_CacheSize: Integer;
begin
    Result := DefaultInterface.CacheSize;
end;

procedure TRecordset.Set_CacheSize(pl: Integer);
begin
  Exit;
end;

function TRecordset.Get_CursorType: CursorTypeEnum;
begin
    Result := DefaultInterface.CursorType;
end;

procedure TRecordset.Set_CursorType(plCursorType: CursorTypeEnum);
begin
  Exit;
end;

function TRecordset.Get_EOF: WordBool;
begin
    Result := DefaultInterface.EOF;
end;

function TRecordset.Get_Fields: Fields15;
begin
    Result := DefaultInterface.Fields;
end;

function TRecordset.Get_LockType: LockTypeEnum;
begin
    Result := DefaultInterface.LockType;
end;

procedure TRecordset.Set_LockType(plLockType: LockTypeEnum);
begin
  Exit;
end;

function TRecordset.Get_MaxRecords: Integer;
begin
    Result := DefaultInterface.MaxRecords;
end;

procedure TRecordset.Set_MaxRecords(plMaxRecords: Integer);
begin
  Exit;
end;

function TRecordset.Get_RecordCount: Integer;
begin
    Result := DefaultInterface.RecordCount;
end;

procedure TRecordset._Set_Source(const pvSource: IDispatch);
  { Warning: The property Source has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
procedure TRecordset.Set_Source(const pvSource: WideString);
  { Warning: The property Source has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecordset.Get_Source: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TRecordset.Get_AbsolutePage: PositionEnum;
begin
    Result := DefaultInterface.AbsolutePage;
end;

procedure TRecordset.Set_AbsolutePage(pl: PositionEnum);
begin
  Exit;
end;

function TRecordset.Get_EditMode: EditModeEnum;
begin
    Result := DefaultInterface.EditMode;
end;

function TRecordset.Get_Filter: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.Filter;
end;

procedure TRecordset.Set_Filter(Criteria: OleVariant);
begin
  Exit;
end;

function TRecordset.Get_PageCount: Integer;
begin
    Result := DefaultInterface.PageCount;
end;

function TRecordset.Get_PageSize: Integer;
begin
    Result := DefaultInterface.PageSize;
end;

procedure TRecordset.Set_PageSize(pl: Integer);
begin
  Exit;
end;

function TRecordset.Get_Sort: WideString;
begin
    Result := DefaultInterface.Sort;
end;

procedure TRecordset.Set_Sort(const Criteria: WideString);
  { Warning: The property Sort has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
  InterfaceVariant: OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  InterfaceVariant.Sort := Criteria;
end;

function TRecordset.Get_Status: Integer;
begin
    Result := DefaultInterface.Status;
end;

function TRecordset.Get_State: Integer;
begin
    Result := DefaultInterface.State;
end;

function TRecordset.Get_CursorLocation: CursorLocationEnum;
begin
    Result := DefaultInterface.CursorLocation;
end;

procedure TRecordset.Set_CursorLocation(plCursorLoc: CursorLocationEnum);
begin
  Exit;
end;

function TRecordset.Get_Collect(Index: OleVariant): OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
  Result := InterfaceVariant.Collect[Index];
end;

procedure TRecordset.Set_Collect(Index: OleVariant; pvar: OleVariant);
begin
  Exit;
end;

function TRecordset.Get_MarshalOptions: MarshalOptionsEnum;
begin
    Result := DefaultInterface.MarshalOptions;
end;

procedure TRecordset.Set_MarshalOptions(peMarshal: MarshalOptionsEnum);
begin
  Exit;
end;

procedure TRecordset.AddNew;
begin
  DefaultInterface.AddNew(EmptyParam, EmptyParam);
end;

procedure TRecordset.AddNew(FieldList: OleVariant);
begin
  DefaultInterface.AddNew(FieldList, EmptyParam);
end;

procedure TRecordset.AddNew(FieldList: OleVariant; Values: OleVariant);
begin
  DefaultInterface.AddNew(FieldList, Values);
end;

procedure TRecordset.CancelUpdate;
begin
  DefaultInterface.CancelUpdate;
end;
...
procedure TRecordset.Delete(AffectRecords: AffectEnum);
begin
  DefaultInterface.Delete(AffectRecords);
end;

function TRecordset.GetRows(Rows: Integer): OleVariant;
begin
  Result := DefaultInterface.GetRows(Rows, EmptyParam, EmptyParam);
end;

function TRecordset.GetRows(Rows: Integer; Start: OleVariant): OleVariant;
begin
  Result := DefaultInterface.GetRows(Rows, Start, EmptyParam);
end;

function TRecordset.GetRows(Rows: Integer; Start: OleVariant; Fields: OleVariant): OleVariant;
begin
  Result := DefaultInterface.GetRows(Rows, Start, Fields);
end;

procedure TRecordset.Move(NumRecords: Integer);
begin
  DefaultInterface.Move(NumRecords, EmptyParam);
end;

procedure TRecordset.Move(NumRecords: Integer; Start: OleVariant);
begin
  DefaultInterface.Move(NumRecords, Start);
end;

procedure TRecordset.MoveNext;
begin
  DefaultInterface.MoveNext;
end;

procedure TRecordset.MovePrevious;
begin
  DefaultInterface.MovePrevious;
end;

procedure TRecordset.MoveFirst;
begin
  DefaultInterface.MoveFirst;
end;

procedure TRecordset.MoveLast;
begin
  DefaultInterface.MoveLast;
end;

procedure TRecordset.Open(Source: OleVariant; ActiveConnection: OleVariant; 
                          CursorType: CursorTypeEnum; LockType: LockTypeEnum; Options: Integer);
begin
  DefaultInterface.Open(Source, ActiveConnection, CursorType, LockType, Options);
end;

procedure TRecordset.Requery(Options: Integer);
begin
  DefaultInterface.Requery(Options);
end;

procedure TRecordset._xResync(AffectRecords: AffectEnum);
begin
  DefaultInterface._xResync(AffectRecords);
end;

procedure TRecordset.Update;
begin
  DefaultInterface.Update(EmptyParam, EmptyParam);
end;

procedure TRecordset.Update(Fields: OleVariant);
begin
  DefaultInterface.Update(Fields, EmptyParam);
end;

procedure TRecordset.Update(Fields: OleVariant; Values: OleVariant);
begin
  DefaultInterface.Update(Fields, Values);
end;

function TRecordset._xClone: Recordset15;
begin
  Result := DefaultInterface._xClone;
end;

procedure TRecordset.UpdateBatch(AffectRecords: AffectEnum);
begin
  DefaultInterface.UpdateBatch(AffectRecords);
end;

procedure TRecordset.CancelBatch(AffectRecords: AffectEnum);
begin
  DefaultInterface.CancelBatch(AffectRecords);
end;

function TRecordset.NextRecordset: Recordset15;
begin
  Result := DefaultInterface.NextRecordset(EmptyParam);
end;

function TRecordset.NextRecordset(out RecordsAffected: OleVariant): Recordset15;
begin
  Result := DefaultInterface.NextRecordset(RecordsAffected);
end;

function TRecordset.Supports(CursorOptions: CursorOptionEnum): WordBool;
begin
  Result := DefaultInterface.Supports(CursorOptions);
end;

procedure TRecordset.Find(const Criteria: WideString; SkipRecords: Integer; 
                          SearchDirection: SearchDirectionEnum);
begin
  DefaultInterface.Find(Criteria, SkipRecords, SearchDirection, EmptyParam);
end;

procedure TRecordset.Find(const Criteria: WideString; SkipRecords: Integer; 
                          SearchDirection: SearchDirectionEnum; Start: OleVariant);
begin
  DefaultInterface.Find(Criteria, SkipRecords, SearchDirection, Start);
end;
...
function TRecordsetProperties.GetDefaultInterface: Recordset15;
begin
  Result := FServer.DefaultInterface;
end;

function TRecordsetProperties.Get_AbsolutePosition: PositionEnum;
begin
    Result := DefaultInterface.AbsolutePosition;
end;

procedure TRecordsetProperties.Set_AbsolutePosition(pl: PositionEnum);
begin
  Exit;
end;

procedure TRecordsetProperties._Set_ActiveConnection(const pvar: IDispatch);
  { Warning: The property ActiveConnection has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
procedure TRecordsetProperties.Set_ActiveConnection(pvar: OleVariant);
  { Warning: The property ActiveConnection has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecordsetProperties.Get_ActiveConnection: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TRecordsetProperties.Get_BOF: WordBool;
begin
    Result := DefaultInterface.BOF;
end;

function TRecordsetProperties.Get_Bookmark: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecordsetProperties.Set_Bookmark(pvBookmark: OleVariant);
begin
  Exit;
end;

function TRecordsetProperties.Get_CacheSize: Integer;
begin
    Result := DefaultInterface.CacheSize;
end;

procedure TRecordsetProperties.Set_CacheSize(pl: Integer);
begin
  Exit;
end;

function TRecordsetProperties.Get_CursorType: CursorTypeEnum;
begin
    Result := DefaultInterface.CursorType;
end;

procedure TRecordsetProperties.Set_CursorType(plCursorType: CursorTypeEnum);
begin
  Exit;
end;

function TRecordsetProperties.Get_EOF: WordBool;
begin
    Result := DefaultInterface.EOF;
end;

function TRecordsetProperties.Get_Fields: Fields15;
begin
    Result := DefaultInterface.Fields;
end;

function TRecordsetProperties.Get_LockType: LockTypeEnum;
begin
    Result := DefaultInterface.LockType;
end;

procedure TRecordsetProperties.Set_LockType(plLockType: LockTypeEnum);
begin
  Exit;
end;

function TRecordsetProperties.Get_MaxRecords: Integer;
begin
    Result := DefaultInterface.MaxRecords;
end;

procedure TRecordsetProperties.Set_MaxRecords(plMaxRecords: Integer);
begin
  Exit;
end;

function TRecordsetProperties.Get_RecordCount: Integer;
begin
    Result := DefaultInterface.RecordCount;
end;

procedure TRecordsetProperties._Set_Source(const pvSource: IDispatch);
  { Warning: The property Source has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
procedure TRecordsetProperties.Set_Source(const pvSource: WideString);
  { Warning: The property Source has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecordsetProperties.Get_Source: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
function TRecordsetProperties.Get_AbsolutePage: PositionEnum;
begin
    Result := DefaultInterface.AbsolutePage;
end;

procedure TRecordsetProperties.Set_AbsolutePage(pl: PositionEnum);
begin
  Exit;
end;

function TRecordsetProperties.Get_EditMode: EditModeEnum;
begin
    Result := DefaultInterface.EditMode;
end;

function TRecordsetProperties.Get_Filter: OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecordsetProperties.Set_Filter(Criteria: OleVariant);
begin
  Exit;
end;

function TRecordsetProperties.Get_PageCount: Integer;
begin
    Result := DefaultInterface.PageCount;
end;

function TRecordsetProperties.Get_PageSize: Integer;
begin
    Result := DefaultInterface.PageSize;
end;

procedure TRecordsetProperties.Set_PageSize(pl: Integer);
begin
  Exit;
end;

function TRecordsetProperties.Get_Sort: WideString;
begin
    Result := DefaultInterface.Sort;
end;

procedure TRecordsetProperties.Set_Sort(const Criteria: WideString);
  { Warning: The property Sort has a setter and a getter whose
  types do not match. Delphi was unable to generate a property of
  this sort and so is using a Variant to set the property instead. }
var
...
function TRecordsetProperties.Get_Status: Integer;
begin
    Result := DefaultInterface.Status;
end;

function TRecordsetProperties.Get_State: Integer;
begin
    Result := DefaultInterface.State;
end;

function TRecordsetProperties.Get_CursorLocation: CursorLocationEnum;
begin
    Result := DefaultInterface.CursorLocation;
end;

procedure TRecordsetProperties.Set_CursorLocation(plCursorLoc: CursorLocationEnum);
begin
  Exit;
end;

function TRecordsetProperties.Get_Collect(Index: OleVariant): OleVariant;
var
  InterfaceVariant : OleVariant;
begin
  InterfaceVariant := DefaultInterface;
...
procedure TRecordsetProperties.Set_Collect(Index: OleVariant; pvar: OleVariant);
begin
  Exit;
end;

function TRecordsetProperties.Get_MarshalOptions: MarshalOptionsEnum;
begin
    Result := DefaultInterface.MarshalOptions;
end;

procedure TRecordsetProperties.Set_MarshalOptions(peMarshal: MarshalOptionsEnum);
begin
  Exit;
end;
...
procedure TParameterProperties.Set_Size(pl: Integer);
begin
  Exit;
end;

function TParameterProperties.Get_Size: Integer;
begin
    Result := DefaultInterface.Size;
end;
