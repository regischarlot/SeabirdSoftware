...
The Original Code is: frmSynEditConfirmReplace.dpr, released 2000-06-23.
...
$Id: frmSynEditConfirmReplace.pas,v 1.2 2000/11/22 08:37:05 mghie Exp $
...
begin
  ...
  if Y2 > AEditorRect.Top + MulDiv(nH, 2, 3) then
    ...
    Inc(Y2, 4);
  SetBounds(max(X, 0), max(Y2, 0), Width, Height);
end;
